...
| [jevgrep (allebee)](https://github.com/allebee/jevgrep) | Log triage | Streaming CLI where code micro-batches lines and owns the `--threshold`, and Jev answers one `Noul` per line against a plain-English question; every judged line is sent to OpenRouter or TypeSafe. |
