...
| [Milvus Model](https://github.com/milvus-io/milvus-model) | Reranker adapter | Jev Noul questions score candidate documents in one request; Python sorts scores, keeps original indices, and applies top-k. |
